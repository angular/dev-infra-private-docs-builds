...
class Tokens {
    ...
    activate(onFailedRefresh) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.expires < Date.now()) {
                if (!(yield this._fetchNewAccessToken())) {
                    return false;
                }
            }
            this._sync();
    ...
    revoke(clientId, ignoreRevokeError) {
        return __awaiter(this, void 0, void 0, function* () {
            this._revoked.abort();
            try {
                const response = yield fetch(`${this.origin}/oauth/revoke`, {
                    method: 'POST',
                    headers: {
    ...
    static fromAuthCode(_a) {
        return __awaiter(this, arguments, void 0, function* ({ editorOrigin, clientId, codeVerifier, authCode, redirectUri, }) {
            const response = yield fetch(`${editorOrigin}/oauth/token`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded',
                },
    ...
    _fetchNewAccessToken() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield fetch(`${this.origin}/oauth/token`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/x-www-form-urlencoded',
                    },
    ...
    _startRefreshTokensLoop(onFailedRefresh) {
        return __awaiter(this, void 0, void 0, function* () {
            while (true) {
                const expiresIn = this.expires - Date.now() - 1000;
                yield wait(Math.max(expiresIn, 1000));
                if (this._revoked.signal.aborted) {
                    return;
                }
...
function S256(input) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const sha256 = new Uint8Array(yield crypto.subtle.digest('SHA-256', ascii));
...
const authState = {
    ...
    editorOrigin: new URL((_a = globalThis.WEBCONTAINER_API_IFRAME_URL) !== null && _a !== void 0 ? _a : DEFAULT_EDITOR_ORIGIN).origin,
    tokens: null,
};
...
const auth$1 = {
    init({ editorOrigin, clientId, scope }) {
        ...
        authState.broadcastChannel.addEventListener('message', (event) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (typedEvent.type === 'auth-complete') {
                ...
                yield authState.tokens.activate(onFailedTokenRefresh);
        ...
        if (authState.tokens) {
            ...
            if (tokens.origin === authState.editorOrigin) {
                ...
                (() => __awaiter(this, void 0, void 0, function* () {
                    const success = yield tokens.activate(onFailedTokenRefresh);
                    if (!success) {
        ...
        if (searchParams.has(SEARCH_PARAM_AUTH_CODE)) {
            ...
            Tokens.fromAuthCode({
                ...
                const success = yield authState.tokens.activate(onFailedTokenRefresh);
    ...
    startAuthFlow() {
        return __awaiter(this, arguments, void 0, function* ({ popup } = {}) {
            if (!authState.initialized) {
            ...
            if (popup) {
                ...
                window.open(yield generateOAuthRequest(), '_blank', `popup,width=${width},height=${height},left=${left},top=${top}`);
            }
            else {
                window.location.href = yield generateOAuthRequest();
            }
        });
    },
    logout() {
        return __awaiter(this, arguments, void 0, function* ({ ignoreRevokeError } = {}) {
            var _a;
            yield ((_a = authState.tokens) === null || _a === void 0 ? void 0 : _a.revoke(authState.clientId, ignoreRevokeError !== null && ignoreRevokeError !== void 0 ? ignoreRevokeError : false));
            loggedOutListeners.fireEvent();
            broadcastMessage({ type: 'auth-logout' });
        });
    },
...
function generateOAuthRequest() {
    return __awaiter(this, void 0, void 0, function* () {
        const codeVerifier = newCodeVerifier();
        localStorage.setItem(STORAGE_CODE_VERIFIER_NAME, codeVerifier);
        const codeChallenge = yield S256(codeVerifier);
